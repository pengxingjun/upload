...
import com.elfinder.services.FsSecurityChecker;
...
public class DefaultFsService implements FsService {
	 ...
	 *         a parent.
	 */
	private Collection<FsItemEx> findRecursively(FsItemFilter filter, FsItem root) {
		List<FsItemEx> results = new ArrayList<FsItemEx>();
	...
	public String getHash(FsItem item) throws IOException {
		...
		String volumeid = getVolumeId(item.getVolume());
